...
class MovieFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getDiscover.let { movies ->
            if (movies.isNotEmpty()) {
                ...
                discoverAdapter.setData(movies)
                binding.discoverLayout.apply {
                    discoverTitle.text = movies[0].title
                    discoverRating.also {
                        it.stepSize = 0.1f
                        it.rating = movies[0].voteAverage?.toFloat()?.div(2) ?: 0f
                    }
                }
            }
        }
        ...
        viewModel.getNowPlaying.let { movies ->
        ...
        viewModel.getUpcoming.let { movies ->
